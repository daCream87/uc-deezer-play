...
Version 0.2.3 source build based on the proven packaging/runtime architecture of the Philips Titan OS Remote 3 integration, with all Philips-specific communication removed.
...
## v0.2.3 multimedia / browse update
...
## v0.2.3 transport / progress / physical buttons
...
## v0.2.3 playlist playback / entity icon fix
